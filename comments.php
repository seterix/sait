...
?>
    <div class="clearfix colelem" id="pu714"><!-- group -->
     <div class="clearfix grpelem" id="u714"><!-- group -->
	  ...
	  <iframe width="630" height="350" src="https://www.youtube.com/embed/e-BK0762d9A" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
VK.Widgets.Comments("vk_comments", {limit: 10, width: "630", attach: false});
</script>
</div>
